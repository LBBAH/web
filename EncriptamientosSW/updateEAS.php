...
<body>
    ...
    <main class="form-signin w-100 m-auto text-center">
        ...
        <form method="Post" action = "./acciones/upEAS.php">
            ...
            <div class="form-floating">
                ...
                <label for="floatingPassword">Contraseña desencriptada</label>
            </div>
            <div class="form-floating" hidden>
                <input type="number" name="id_type" class="form-control" id="floatingid_type" placeholder="id_type" value="1">
                <label for="floatingid_type">id_type</label>
            </div>

            <div class="checkbox mb-3">
                <label>
                    Decifrado simétrico AES
                </label>
            </div>            
