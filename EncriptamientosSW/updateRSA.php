...
include_once "./acciones/functions.php";
...
list($encrypted_passW, $r3) = explode('::', base64_decode($r),2);

$d = openssl_decrypt($encrypted_passW, 'aes-256-cbc', $r2, 0,$r3);
...
<body>
    ...
    <main class="form-signin w-100 m-auto text-center">
        ...
        <form method="Post" action = "./acciones/upRSA.php">
            ...
            <div class="form-floating">
                <input type="text" name="password" class="form-control" id="floatingPassword" value="<?php echo $d?>" placeholder="contraseña">
                <label for="floatingPassword">Nueva contraseña</label>
            </div>
            <div class="form-floating" hidden>
                <input type="number" name="id_type" class="form-control" id="floatingid_type" placeholder="id_type" value="2">
